...
import pdf from '../images/shivam cv (1).pdf'
            ...
            <div style={{ backgroundImage: `url(${img})`, width: "100%", height: "100vh" }}>
                <div className="container pt-5">
                    <div className="center-vertically pt-5">
                        ...
                        <h1 className="text-white font-bold text-40 line-height-60">I am Shivam Singh<Typewriter
                            options={{
                                strings: ['A Full Stack Developer.', 'I Love Coding.'],
                                autoStart: true,
                                loop: true,
                            }}
                        /></h1>
